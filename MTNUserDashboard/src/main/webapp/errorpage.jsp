<%-- 
    Document   : errorpage
    Created on : Feb 11, 2018, 3:53:53 PM
    Author     : alireza
--%>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					...
					<ul class="return-btn center-block">
						<li>
							<a href="PageManage?page=login" class="wow slideInLeft">Home <span class="icons-container"><span class="home-icon"></span></span></a>
						</li>
						<li>
							<a href="PageManage?page=revenue" class="wow slideInRight">Return Back <span class="icons-container"><span class="return-icon"></span></span></a>
						</li>
					</ul>
