...
public class ObjectFactory {
    ...
    private final static QName _SyncSubscriptionActiveResponse_QNAME = new QName("http://www.csapi.org/schema/parlayx/data/sync/v1_0/local", "syncSubscriptionActiveResponse");
    private final static QName _SyncSubscriptionActive_QNAME = new QName("http://www.csapi.org/schema/parlayx/data/sync/v1_0/local", "syncSubscriptionActive");
    ...
    /**
     * Create an instance of {@link SyncSubscriptionActiveResponse }
     * 
     */
    public SyncSubscriptionActiveResponse createSyncSubscriptionActiveResponse() {
        return new SyncSubscriptionActiveResponse();
    }

    /**
     * Create an instance of {@link SyncSubscriptionActive }
     * 
     */
    public SyncSubscriptionActive createSyncSubscriptionActive() {
        return new SyncSubscriptionActive();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SyncSubscriptionActiveResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/data/sync/v1_0/local", name = "syncSubscriptionActiveResponse")
    public JAXBElement<SyncSubscriptionActiveResponse> createSyncSubscriptionActiveResponse(SyncSubscriptionActiveResponse value) {
        return new JAXBElement<SyncSubscriptionActiveResponse>(_SyncSubscriptionActiveResponse_QNAME, SyncSubscriptionActiveResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SyncSubscriptionActive }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.csapi.org/schema/parlayx/data/sync/v1_0/local", name = "syncSubscriptionActive")
    public JAXBElement<SyncSubscriptionActive> createSyncSubscriptionActive(SyncSubscriptionActive value) {
        return new JAXBElement<SyncSubscriptionActive>(_SyncSubscriptionActive_QNAME, SyncSubscriptionActive.class, null, value);
    }
